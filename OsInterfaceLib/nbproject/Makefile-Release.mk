...
${OBJECTDIR}/src/CBaseBlock.o: src/CBaseBlock.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CBaseBlock.o src/CBaseBlock.cpp

${OBJECTDIR}/src/CControlLogger.o: src/CControlLogger.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CControlLogger.o src/CControlLogger.cpp

${OBJECTDIR}/src/CDefaultDevice.o: src/CDefaultDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CDefaultDevice.o src/CDefaultDevice.cpp

${OBJECTDIR}/src/CDefaultHardware.o: src/CDefaultHardware.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CDefaultHardware.o src/CDefaultHardware.cpp

${OBJECTDIR}/src/CDefaultLogger.o: src/CDefaultLogger.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CDefaultLogger.o src/CDefaultLogger.cpp

${OBJECTDIR}/src/CFileDownloader.o: src/CFileDownloader.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFileDownloader.o src/CFileDownloader.cpp

${OBJECTDIR}/src/CGenericDevice.o: src/CGenericDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericDevice.o src/CGenericDevice.cpp

${OBJECTDIR}/src/CGenericHardware.o: src/CGenericHardware.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericHardware.o src/CGenericHardware.cpp

${OBJECTDIR}/src/CGenericMessage.o: src/CGenericMessage.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericMessage.o src/CGenericMessage.cpp

${OBJECTDIR}/src/CGenericMessageManager.o: src/CGenericMessageManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericMessageManager.o src/CGenericMessageManager.cpp

${OBJECTDIR}/src/CGenericSoftware.o: src/CGenericSoftware.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericSoftware.o src/CGenericSoftware.cpp

${OBJECTDIR}/src/CGenericTestPort.o: src/CGenericTestPort.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericTestPort.o src/CGenericTestPort.cpp

${OBJECTDIR}/src/CGenericTime.o: src/CGenericTime.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericTime.o src/CGenericTime.cpp

${OBJECTDIR}/src/CLinuxCommPort.o: src/CLinuxCommPort.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxCommPort.o src/CLinuxCommPort.cpp

${OBJECTDIR}/src/CLinuxCurrentTime.o: src/CLinuxCurrentTime.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxCurrentTime.o src/CLinuxCurrentTime.cpp

${OBJECTDIR}/src/CLinuxFile.o: src/CLinuxFile.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxFile.o src/CLinuxFile.cpp

${OBJECTDIR}/src/CLinuxHardware.o: src/CLinuxHardware.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxHardware.o src/CLinuxHardware.cpp

${OBJECTDIR}/src/CLinuxPort.o: src/CLinuxPort.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxPort.o src/CLinuxPort.cpp

${OBJECTDIR}/src/CLinuxSocketClient.o: src/CLinuxSocketClient.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxSocketClient.o src/CLinuxSocketClient.cpp

${OBJECTDIR}/src/CLinuxSocketServer.o: src/CLinuxSocketServer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxSocketServer.o src/CLinuxSocketServer.cpp

${OBJECTDIR}/src/CLinuxSoftware.o: src/CLinuxSoftware.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxSoftware.o src/CLinuxSoftware.cpp

${OBJECTDIR}/src/CLinuxSpiPort.o: src/CLinuxSpiPort.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxSpiPort.o src/CLinuxSpiPort.cpp

${OBJECTDIR}/src/CLinuxZeroTime.o: src/CLinuxZeroTime.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxZeroTime.o src/CLinuxZeroTime.cpp

${OBJECTDIR}/src/CMapToPointer.o: src/CMapToPointer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CMapToPointer.o src/CMapToPointer.cpp

${OBJECTDIR}/src/CMessageManager.o: src/CMessageManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CMessageManager.o src/CMessageManager.cpp

${OBJECTDIR}/src/CProtocol.o: src/CProtocol.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CProtocol.o src/CProtocol.cpp

${OBJECTDIR}/src/CRawData.o: src/CRawData.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CRawData.o src/CRawData.cpp

${OBJECTDIR}/src/CVxWorkCommPort.o: src/CVxWorkCommPort.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CVxWorkCommPort.o src/CVxWorkCommPort.cpp

${OBJECTDIR}/src/CVxWorkHardware.o: src/CVxWorkHardware.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CVxWorkHardware.o src/CVxWorkHardware.cpp

${OBJECTDIR}/src/CVxWorkSoftware.o: src/CVxWorkSoftware.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CVxWorkSoftware.o src/CVxWorkSoftware.cpp

${OBJECTDIR}/src/CVxWorkSpiPort.o: src/CVxWorkSpiPort.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CVxWorkSpiPort.o src/CVxWorkSpiPort.cpp

${OBJECTDIR}/src/CVxWorkThread.o: src/CVxWorkThread.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CVxWorkThread.o src/CVxWorkThread.cpp

${OBJECTDIR}/src/CWindowsCommPort.o: src/CWindowsCommPort.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsCommPort.o src/CWindowsCommPort.cpp

${OBJECTDIR}/src/CWindowsCurrentTime.o: src/CWindowsCurrentTime.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsCurrentTime.o src/CWindowsCurrentTime.cpp

${OBJECTDIR}/src/CWindowsFile.o: src/CWindowsFile.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsFile.o src/CWindowsFile.cpp

${OBJECTDIR}/src/CWindowsHardware.o: src/CWindowsHardware.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsHardware.o src/CWindowsHardware.cpp

${OBJECTDIR}/src/CWindowsPort.o: src/CWindowsPort.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsPort.o src/CWindowsPort.cpp

${OBJECTDIR}/src/CWindowsSocketClient.o: src/CWindowsSocketClient.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsSocketClient.o src/CWindowsSocketClient.cpp

${OBJECTDIR}/src/CWindowsSocketServer.o: src/CWindowsSocketServer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsSocketServer.o src/CWindowsSocketServer.cpp

${OBJECTDIR}/src/CWindowsSoftware.o: src/CWindowsSoftware.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsSoftware.o src/CWindowsSoftware.cpp

${OBJECTDIR}/src/CWindowsSpiPort.o: src/CWindowsSpiPort.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsSpiPort.o src/CWindowsSpiPort.cpp

${OBJECTDIR}/src/CWindowsZeroTime.o: src/CWindowsZeroTime.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsZeroTime.o src/CWindowsZeroTime.cpp
...
${TESTDIR}/TestFiles/f2: ${TESTDIR}/tests/TestProtocolclass.o ${TESTDIR}/tests/newtestrunner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f2 $^ ${LDLIBSOPTIONS} -lpthread `cppunit-config --libs`   
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/CLinuxServerSocketTest.o ${TESTDIR}/tests/testrunnerserversocket.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS} -lpthread `cppunit-config --libs`   


${TESTDIR}/tests/filedownloadertest.o: tests/filedownloadertest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Iinc -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/filedownloadertest.o tests/filedownloadertest.cpp


${TESTDIR}/tests/TestProtocolclass.o: tests/TestProtocolclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Iinc `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestProtocolclass.o tests/TestProtocolclass.cpp


${TESTDIR}/tests/newtestrunner.o: tests/newtestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Iinc `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestrunner.o tests/newtestrunner.cpp


${TESTDIR}/tests/CLinuxServerSocketTest.o: tests/CLinuxServerSocketTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Iinc `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CLinuxServerSocketTest.o tests/CLinuxServerSocketTest.cpp


${TESTDIR}/tests/testrunnerserversocket.o: tests/testrunnerserversocket.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Iinc `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testrunnerserversocket.o tests/testrunnerserversocket.cpp
...
${OBJECTDIR}/src/CBaseBlock_nomain.o: ${OBJECTDIR}/src/CBaseBlock.o src/CBaseBlock.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CBaseBlock_nomain.o src/CBaseBlock.cpp;\
	else  \
...
${OBJECTDIR}/src/CControlLogger_nomain.o: ${OBJECTDIR}/src/CControlLogger.o src/CControlLogger.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CControlLogger_nomain.o src/CControlLogger.cpp;\
	else  \
...
${OBJECTDIR}/src/CDefaultDevice_nomain.o: ${OBJECTDIR}/src/CDefaultDevice.o src/CDefaultDevice.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CDefaultDevice_nomain.o src/CDefaultDevice.cpp;\
	else  \
...
${OBJECTDIR}/src/CDefaultHardware_nomain.o: ${OBJECTDIR}/src/CDefaultHardware.o src/CDefaultHardware.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CDefaultHardware_nomain.o src/CDefaultHardware.cpp;\
	else  \
...
${OBJECTDIR}/src/CDefaultLogger_nomain.o: ${OBJECTDIR}/src/CDefaultLogger.o src/CDefaultLogger.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CDefaultLogger_nomain.o src/CDefaultLogger.cpp;\
	else  \
...
${OBJECTDIR}/src/CFileDownloader_nomain.o: ${OBJECTDIR}/src/CFileDownloader.o src/CFileDownloader.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CFileDownloader_nomain.o src/CFileDownloader.cpp;\
	else  \
...
${OBJECTDIR}/src/CGenericDevice_nomain.o: ${OBJECTDIR}/src/CGenericDevice.o src/CGenericDevice.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericDevice_nomain.o src/CGenericDevice.cpp;\
	else  \
...
${OBJECTDIR}/src/CGenericHardware_nomain.o: ${OBJECTDIR}/src/CGenericHardware.o src/CGenericHardware.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericHardware_nomain.o src/CGenericHardware.cpp;\
	else  \
...
${OBJECTDIR}/src/CGenericMessage_nomain.o: ${OBJECTDIR}/src/CGenericMessage.o src/CGenericMessage.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericMessage_nomain.o src/CGenericMessage.cpp;\
	else  \
...
${OBJECTDIR}/src/CGenericMessageManager_nomain.o: ${OBJECTDIR}/src/CGenericMessageManager.o src/CGenericMessageManager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericMessageManager_nomain.o src/CGenericMessageManager.cpp;\
	else  \
...
${OBJECTDIR}/src/CGenericSoftware_nomain.o: ${OBJECTDIR}/src/CGenericSoftware.o src/CGenericSoftware.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericSoftware_nomain.o src/CGenericSoftware.cpp;\
	else  \
...
${OBJECTDIR}/src/CGenericTestPort_nomain.o: ${OBJECTDIR}/src/CGenericTestPort.o src/CGenericTestPort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericTestPort_nomain.o src/CGenericTestPort.cpp;\
	else  \
...
${OBJECTDIR}/src/CGenericTime_nomain.o: ${OBJECTDIR}/src/CGenericTime.o src/CGenericTime.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CGenericTime_nomain.o src/CGenericTime.cpp;\
	else  \
...
${OBJECTDIR}/src/CLinuxCommPort_nomain.o: ${OBJECTDIR}/src/CLinuxCommPort.o src/CLinuxCommPort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxCommPort_nomain.o src/CLinuxCommPort.cpp;\
	else  \
...
${OBJECTDIR}/src/CLinuxCurrentTime_nomain.o: ${OBJECTDIR}/src/CLinuxCurrentTime.o src/CLinuxCurrentTime.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxCurrentTime_nomain.o src/CLinuxCurrentTime.cpp;\
	else  \
...
${OBJECTDIR}/src/CLinuxFile_nomain.o: ${OBJECTDIR}/src/CLinuxFile.o src/CLinuxFile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxFile_nomain.o src/CLinuxFile.cpp;\
	else  \
...
${OBJECTDIR}/src/CLinuxHardware_nomain.o: ${OBJECTDIR}/src/CLinuxHardware.o src/CLinuxHardware.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxHardware_nomain.o src/CLinuxHardware.cpp;\
	else  \
...
${OBJECTDIR}/src/CLinuxPort_nomain.o: ${OBJECTDIR}/src/CLinuxPort.o src/CLinuxPort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxPort_nomain.o src/CLinuxPort.cpp;\
	else  \
...
${OBJECTDIR}/src/CLinuxSocketClient_nomain.o: ${OBJECTDIR}/src/CLinuxSocketClient.o src/CLinuxSocketClient.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxSocketClient_nomain.o src/CLinuxSocketClient.cpp;\
	else  \
...
${OBJECTDIR}/src/CLinuxSocketServer_nomain.o: ${OBJECTDIR}/src/CLinuxSocketServer.o src/CLinuxSocketServer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxSocketServer_nomain.o src/CLinuxSocketServer.cpp;\
	else  \
...
${OBJECTDIR}/src/CLinuxSoftware_nomain.o: ${OBJECTDIR}/src/CLinuxSoftware.o src/CLinuxSoftware.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxSoftware_nomain.o src/CLinuxSoftware.cpp;\
	else  \
...
${OBJECTDIR}/src/CLinuxSpiPort_nomain.o: ${OBJECTDIR}/src/CLinuxSpiPort.o src/CLinuxSpiPort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxSpiPort_nomain.o src/CLinuxSpiPort.cpp;\
	else  \
...
${OBJECTDIR}/src/CLinuxZeroTime_nomain.o: ${OBJECTDIR}/src/CLinuxZeroTime.o src/CLinuxZeroTime.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CLinuxZeroTime_nomain.o src/CLinuxZeroTime.cpp;\
	else  \
...
${OBJECTDIR}/src/CMapToPointer_nomain.o: ${OBJECTDIR}/src/CMapToPointer.o src/CMapToPointer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CMapToPointer_nomain.o src/CMapToPointer.cpp;\
	else  \
...
${OBJECTDIR}/src/CMessageManager_nomain.o: ${OBJECTDIR}/src/CMessageManager.o src/CMessageManager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CMessageManager_nomain.o src/CMessageManager.cpp;\
	else  \
...
${OBJECTDIR}/src/CProtocol_nomain.o: ${OBJECTDIR}/src/CProtocol.o src/CProtocol.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CProtocol_nomain.o src/CProtocol.cpp;\
	else  \
...
${OBJECTDIR}/src/CRawData_nomain.o: ${OBJECTDIR}/src/CRawData.o src/CRawData.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CRawData_nomain.o src/CRawData.cpp;\
	else  \
...
${OBJECTDIR}/src/CVxWorkCommPort_nomain.o: ${OBJECTDIR}/src/CVxWorkCommPort.o src/CVxWorkCommPort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CVxWorkCommPort_nomain.o src/CVxWorkCommPort.cpp;\
	else  \
...
${OBJECTDIR}/src/CVxWorkHardware_nomain.o: ${OBJECTDIR}/src/CVxWorkHardware.o src/CVxWorkHardware.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CVxWorkHardware_nomain.o src/CVxWorkHardware.cpp;\
	else  \
...
${OBJECTDIR}/src/CVxWorkSoftware_nomain.o: ${OBJECTDIR}/src/CVxWorkSoftware.o src/CVxWorkSoftware.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CVxWorkSoftware_nomain.o src/CVxWorkSoftware.cpp;\
	else  \
...
${OBJECTDIR}/src/CVxWorkSpiPort_nomain.o: ${OBJECTDIR}/src/CVxWorkSpiPort.o src/CVxWorkSpiPort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CVxWorkSpiPort_nomain.o src/CVxWorkSpiPort.cpp;\
	else  \
...
${OBJECTDIR}/src/CVxWorkThread_nomain.o: ${OBJECTDIR}/src/CVxWorkThread.o src/CVxWorkThread.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CVxWorkThread_nomain.o src/CVxWorkThread.cpp;\
	else  \
...
${OBJECTDIR}/src/CWindowsCommPort_nomain.o: ${OBJECTDIR}/src/CWindowsCommPort.o src/CWindowsCommPort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsCommPort_nomain.o src/CWindowsCommPort.cpp;\
	else  \
...
${OBJECTDIR}/src/CWindowsCurrentTime_nomain.o: ${OBJECTDIR}/src/CWindowsCurrentTime.o src/CWindowsCurrentTime.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsCurrentTime_nomain.o src/CWindowsCurrentTime.cpp;\
	else  \
...
${OBJECTDIR}/src/CWindowsFile_nomain.o: ${OBJECTDIR}/src/CWindowsFile.o src/CWindowsFile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsFile_nomain.o src/CWindowsFile.cpp;\
	else  \
...
${OBJECTDIR}/src/CWindowsHardware_nomain.o: ${OBJECTDIR}/src/CWindowsHardware.o src/CWindowsHardware.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsHardware_nomain.o src/CWindowsHardware.cpp;\
	else  \
...
${OBJECTDIR}/src/CWindowsPort_nomain.o: ${OBJECTDIR}/src/CWindowsPort.o src/CWindowsPort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsPort_nomain.o src/CWindowsPort.cpp;\
	else  \
...
${OBJECTDIR}/src/CWindowsSocketClient_nomain.o: ${OBJECTDIR}/src/CWindowsSocketClient.o src/CWindowsSocketClient.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsSocketClient_nomain.o src/CWindowsSocketClient.cpp;\
	else  \
...
${OBJECTDIR}/src/CWindowsSocketServer_nomain.o: ${OBJECTDIR}/src/CWindowsSocketServer.o src/CWindowsSocketServer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsSocketServer_nomain.o src/CWindowsSocketServer.cpp;\
	else  \
...
${OBJECTDIR}/src/CWindowsSoftware_nomain.o: ${OBJECTDIR}/src/CWindowsSoftware.o src/CWindowsSoftware.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsSoftware_nomain.o src/CWindowsSoftware.cpp;\
	else  \
...
${OBJECTDIR}/src/CWindowsSpiPort_nomain.o: ${OBJECTDIR}/src/CWindowsSpiPort.o src/CWindowsSpiPort.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsSpiPort_nomain.o src/CWindowsSpiPort.cpp;\
	else  \
...
${OBJECTDIR}/src/CWindowsZeroTime_nomain.o: ${OBJECTDIR}/src/CWindowsZeroTime.o src/CWindowsZeroTime.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -DENABLE_TEST -DUSE_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CWindowsZeroTime_nomain.o src/CWindowsZeroTime.cpp;\
	else  \
